...
import { findCartHutang, updatePartialByCartId } from "../services/db";
import RupiahFormat from "../utilities/RupiahFormat";
import api from "../utilities/axiosInterceptor";
import isOnline from "../utilities/isOnline";
import dayjs from "dayjs";

function ModalShowHutangOffline({ isOpen, closeModal, reloadDataOnline }) {
  const [dataOffline, setDataOffline] = useState([]);
  //
  const getDataOffline = async () => {
    const alltransaksiOffline = await findCartHutang();
...
export default ModalShowHutangOffline;
