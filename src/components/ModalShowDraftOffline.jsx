...
import { findCartBooking, updatePartialByCartId } from "../services/db";
import RupiahFormat from "../utilities/RupiahFormat";
import api from "../utilities/axiosInterceptor";
import isOnline from "../utilities/isOnline";
import dayjs from "dayjs";

function ModalShowDraftOffline({ isOpen, closeModal, reloadDataOnline }) {
  const [dataOffline, setDataOffline] = useState([]);
  //
  const getDataOffline = async () => {
    const alltransaksiOffline = await findCartBooking();
        ...
        <div className="bg-white w-[95%] md:w-[60%] h-[90%] p-6 rounded-lg shadow-lg relative z-10 flex flex-col">
          ...
          <div className="flex-none">
            <h2 className="text-base md:text-lg font-bold mb-2 text-black">
              Daftar Draft Penjualan offline
            </h2>
...
export default ModalShowDraftOffline;
