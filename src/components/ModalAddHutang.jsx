      ...
      if (isOnline) {
        try {
          ...
          if (response.data.success) {
            ...
            PilihPrintHutang(response.data.cartData, response.data.cartDraft);
          } else {
            toast.update(toastId, {
              render: `${response.data.message}`,
              type: "error",
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white w-[90%] md:w-1/2 h-auto p-4 md:p-6 rounded-lg shadow-lg relative z-10">
        <h2 className="text-sm md:text-lg xl:text-xl font-bold mb-2 md:mb-4 text-black font-poppins">
          Draft <span className="text-red-500">Hutang</span>
        </h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between mt-5 text-sm md:text-base">
            ...
            >
              <i className="fa fa-save"></i> Simpan Hutang
            </button>
          </div>
        </form>
      </div>
